...
class OptimierungBefundAusTest(QDialog):
    def __init__(self, gdtDateiOriginal:class_gdtdatei.GdtDatei, maxeindeutigkeitskriterien:int, testuebernahmen:list, befundzeile:str):
        ...
        groupBoxTestuebernahmeDefinieren.setFont(self.fontBoldItalic)
        ...
        labelPlatzhalterName = QLabel("Platzhalter")
        ...
        dialogLayoutGPlatzhalter.addWidget(labelPlatzhalterName, 0, 0)
        dialogLayoutGPlatzhalter.addWidget(labelPlatzhalterFeldkennung, 0, 1)
        dialogLayoutGPlatzhalter.addWidget(self.lineEditPlatzhalterName, 1, 0)
        dialogLayoutGPlatzhalter.addWidget(self.lineEditPlatzhalterFeldkennung, 1, 1)
